...
const DeletedItemsPage = () => {
  ...
  const fetchDeleted = async () => {
    if (!isAdmin) return; // Guard against fetching if not authorized
    setIsLoading(true);
    try {
  ...
  // UI GUARD: If not Admin, show a styled Access Denied message instead of the table
  if (!isAdmin) {
    return (
      ...
      <div className="dip-root">
        ...
        <div className="dip-body">
          ...
          <div className="table-panel">
            ...
            {isLoading ? (
              <div className="table-state"><div className="loader" /><p>Loading deleted products…</p></div>
            ) : (
                    ...
                    <tr>
                      <td colSpan={5}>
                        <div className="table-state">
                          <p>{search ? 'No deleted products match your search.' : 'No deleted products found. The archive is clean!'}</p>
                        </div>
                      </td>
                    </tr>
                  ) : (
