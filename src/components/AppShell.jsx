...
const NAV_ITEMS = [
 ...
 },
 {
   ...
   items: [
     {
       // FIX: was 'Reports' — changed to 'Product Report' to match sprint deliverable and M2's page name
     ...
     {
       // FIX: was 'Insights' — changed to 'Top Selling' to match sprint deliverable and M2's page name
       label: 'Top Selling',
...
const getPageLabel = (pathname) => {
 const map = {
   ...
   // FIX: was 'Reports' — changed to 'Product Report' to match M2's page name
   '/reports/products':    'Product Report',
   // FIX: was 'Insights' — changed to 'Top Selling' to match M2's page name
